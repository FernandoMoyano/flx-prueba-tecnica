...
--10_SUELDO MINIMO EN EL DEPARTAMENTO SOPORTE
SELECT MIN(SUELDO) AS Mínimo_Sueldo 
FROM EMPLEADOS 
JOIN DEPARTAMENTOS ON EMPLEADOS.DEPARTAMENTO_ID = DEPARTAMENTOS.ID 
JOIN PUESTOS ON EMPLEADOS.PUESTO_ID = PUESTOS.ID 
...
--11_SUMA DE SUELDOS POR PUESTO
SELECT PUESTOS.PUESTO, SUM(SUELDO) AS Suma _de_Sueldos
FROM EMPLEADOS 
JOIN PUESTOS ON EMPLEADOS.PUESTO_ID = PUESTOS.ID 
